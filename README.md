...
- 输出 `project_status_latest_task_has_business_context`、`project_status_latest_task_has_eval_result`、`project_status_latest_task_eval_overall_score` 等 latest task artifact / evaluation 摘要字段
